...
class UploaderPage:
    """Upload page with user-configurable paths."""
    ...
    def build(self, parent_window=None):
        ...
        remote_label = Gtk.Label(label="Proton Drive Remote Path: \n\n Your Defaults normally are in your Directory are w/ /my-files: Documents, Pictures, Videos, Music, Downloads")
        ...
        self.entry_remote.set_placeholder_text("/my-files/app-uility")
        self.entry_remote.set_text("/my-files/app-utility")
