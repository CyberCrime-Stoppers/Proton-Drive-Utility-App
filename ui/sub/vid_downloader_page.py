...
class VidDownloaderPage:
    """Cutom: Downloader page 'Downloads' with user-configurable paths."""
    ...
    def build(self, parent_window=None):
        ...
        self.entry_remote.set_placeholder_text("/my-files/Videos")
        self.entry_remote.set_text("/my-files/Videos")
