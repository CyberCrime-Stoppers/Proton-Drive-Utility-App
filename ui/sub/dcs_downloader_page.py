...
class DcsDownloaderPage:
    """Cutom: Download page 'Documents' with user-configurable paths."""
    ...
    def build(self, parent_window=None):
        ...
        self.entry_remote.set_placeholder_text("/my-files/Documents")
        self.entry_remote.set_text("/my-files/Documents")
        ...
        local_box = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL, spacing=4)
        local_box.set_size_request(400, -1)

        self.entry_local = Gtk.Entry()
        self.entry_local.set_placeholder_text("/")
        self.entry_local.set_text(os.path.expanduser("Click browse to choose a directory where you like your download to be"))
