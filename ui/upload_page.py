...
class UploadPage:
    """Upload page with functional buttons."""
    ...
    def build(self, parent_window=None):  # ← FIXED
        ...
        info = Gtk.Label(label=(
           " ''Click on any of these options to export your file onto your personal proton drive \n and it will automaticly put all of your file automaticly into the right folder in the cloud *shown below''"
        ))
        info.add_css_class("dim-label")
        container.append(info)

        # --- Button: Upload Documents ---
        btn_dcs = Gtk.Button(label="Export from Directory: Documents")
        ...
        btn_pcs = Gtk.Button(label="Export from Directory: Pictures")
    ...
    def _run_script(self, widget, folder_name):
        if folder_name == "Documents":
            script_path = "./scripts/up/prtn-drv-hme-dcs.sh"
        elif folder_name == "Pictures":
            script_path = "./scripts/up/prtn-drv-hme-pcs.sh"
        elif folder_name == "Videos":
            script_path = "./scripts/up/prtn-drv-hme-vid.sh"
        elif folder_name == "Music":
            script_path = "./scripts/up/prtn-drv-hme-mus.sh"
        elif folder_name == "Downloads":
            script_path = "./scripts/up/prtn-drv-hme-dnld.sh"
        else:
